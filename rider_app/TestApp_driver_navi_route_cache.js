...
//      console.log(`get_route(${JSON.stringify(from)}, ${JSON.stringify(to)}): new_route_object=${JSON.stringify(new_route_object)}`);
      ...
      var distance_change = getDistancePointToPoint(from, decorated_new_route_object.route[1]) - getDistancePointToPoint(decorated_new_route_object.route[0], decorated_new_route_object.route[1]);
