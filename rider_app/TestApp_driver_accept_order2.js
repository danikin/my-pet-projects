...
{  
  ...
  {
    console.log(`The driver is assiggned2: this.API_driver_id=${this.API_driver_id}, this.assigned_order_id=${this.assigned_order_id}`)
        ...
        return (
          <View style={styles.container}>
            <MapView provider={PROVIDER_GOOGLE} style={styles.mapStyle}
              ...
              onLayout={() => {
                this.map.animateCamera({center: {latitude: 61.666594,longitude: 50.827201},pitch: 2, heading: 20,altitude: 200, zoom: 40}, 5000)
              }}
              initialRegion={{
                latitude: 61.666594,
                longitude: 50.827201,
