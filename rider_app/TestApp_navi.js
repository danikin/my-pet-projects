...
{  
  ...
  // Store 10 recent driver's info to get recent coordinate for the camera angle on the navigation map
  if (this.driver !== undefined)
  {
    this.prev_one_driver = this.driver;
    this.prev_driver_info.push(this.driver);
    if (this.prev_driver_info.length > 10)
      this.prev_driver_info.shift();
