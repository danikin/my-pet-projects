...
coordinates={this.state.coords2}
	...
	strokeWidth={10}/>
        ...
        <View style={{flex: 1, position: 'absolute', left : 10, right : 10, bottom: 20, alignItems: "center"}}>
          ...
          <View style={{flex: 0.4, flexDirection: 'row'}}>
            <TouchableOpacity onPress={()=>{this.setState({is_in_chat: !this.state.is_in_chat})}}><MaterialIcons name="feedback" size={36} color="black"/>
</TouchableOpacity>
            <TouchableOpacity onPress={()=>{this.setState({is_in_chat: !this.state.is_in_chat})}}><MaterialIcons name="chat" size={36} color="black"/>
</TouchableOpacity>
