...
decorateRoute(current_point, route)
{
  ...
  for (let point of route)
  {
    if (n >= 1)
    {
      ...
      var cur_r = route_cache.getRotation(route[n-1], route[n]);
      ...
      if (n >= 2)
      {
        ...
        if (r > 30 && r < 150)
        {
          ...
          return{
            ...
            next_turn_direction : (distance_to_turn < 50) ? "" : (
  ...
  route_cache.get_route(from_coordinate, to_coordinate,
    function(route_object)
    {
      ...
      this.setState({
            ...
            coords1: is_route_to_B ? [] : route_object.route,
            distance1 : is_route_to_B ? 0 : route_object.distance,
            duration1 : is_route_to_B ? 0 : route_object.duration,

            coords2: is_route_to_B ? route_object.route : [],
            distance2 : is_route_to_B ? route_object.distance : 0,
            duration2: is_route_to_B ? route_object.duration : 0,
...
//  console.log(`API_on_message, this.API_driver_id: ${this.API_driver_id}, e:${JSON.stringify(e)}`)
      ...
      this.assigned_order_id != -1)
  {
    ...
    var rotation = route_cache.getRotation(
