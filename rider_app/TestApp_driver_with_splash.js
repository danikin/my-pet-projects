    ...
    if (this.state.page == "splash")
    {
      return (
          <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            <View><Text style={{fontSize: '21px', color: 'black', fontWeight: 'bold', fontFamily: 'Roboto'}}>TAXI</Text></View>
          </View>
      );
    }
    else
	...
	strokeWidth={10}/>
      ...
      <View style={{flex:1, position: 'absolute', top: 30}}>
        ...
        <View style={{flex: 5, flexDirection: 'row'}}>
          ...
          <MaterialIcons style={{flex: 1}} name="smoke-free" size={24} color="black" />
          <MaterialCommunityIcons style={{flex: 1}} name="bank-transfer" size={24} color="black" />
          <MaterialCommunityIcons style={{flex: 1}} name="human-male-boy" size={24} color="black" />
      ...
      <View style={{flex:1, position: 'absolute', bottom: 10}}>
        ...
        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          <TouchableOpacity><MaterialCommunityIcons name="auto-fix" size={36} color="black" /></TouchableOpacity>
        </View>
      </View>
...
coordinates={this.state.coords2}
	...
	strokeWidth={10}/>
          ...
          <View style={{position: 'absolute', left : 10, right : 10, top: 30, alignItems: "center", padding: 10, borderColor: 'black', borderWidth: 1, flex: 1, flexDirection: "column", backgroundColor: 'white'}}>
