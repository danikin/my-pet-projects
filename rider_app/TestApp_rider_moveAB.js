...
findHouse(address)
{
  ...
  .then(responseJson => {
      ...
      */
      ...
      fetch("http://185.241.194.113:1234/rider/move_B?token=2EYBC3ENU6MW8FX58Z0TYKPBXTN50LU2&flow_id=1544493867&lat=" + this.latB + "&lon=" + this.lonB);
  })
}
...
fetch("http://185.241.194.113:1234/rider/move_A?token=2EYBC3ENU6MW8FX58Z0TYKPBXTN50LU2&flow_id=1544493867&lat=" + this.latA + "&lon=" + this.lonA);
