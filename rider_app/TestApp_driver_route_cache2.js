...
//    console.log(`get_route(${JSON.stringify(from)}, ${JSON.stringify(to)}): first hand cache hit, cache_hits1=${cache_hits1}, route_first_hand=${JSON.stringify(route_first_hand)}`);
  ...
  if (route_second_hand !== undefined)
  {
    ...
    console.log(`get_route(${JSON.stringify(from)}, ${JSON.stringify(to)}): second hand cache hit, cache_hits2=${cache_hits2}, route_second_hand=${JSON.stringify(route_second_hand)}, single_point_cache size is ${single_point_cache.size}`);
